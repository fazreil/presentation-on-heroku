...
| SAST | DAST|
|-------------------|------------------|
|White box security testing <br/>-access the underlying framework <br/>- Application tested from inside out <br/>- testing represent developer approach| Black box security testing<br/>-no knowledge of the framework or technologies <br/>-tested from outside in <br/>-testing represent hacker approach|
...
|Less expensive | More expensive to solve the vulnerabilities |
